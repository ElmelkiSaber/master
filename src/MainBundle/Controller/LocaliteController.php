...
use MainBundle\Entity\Localite;
...
class LocaliteController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $localites = $em->getRepository('MainBundle:Localite')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('MainBundle\Form\LocaliteType', $localite);
    ...
    {
        $deleteForm = $this->createDeleteForm($localite);
        $editForm = $this->createForm('MainBundle\Form\LocaliteType', $localite);
